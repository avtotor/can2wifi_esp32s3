...
static void load_settings(void) {
    ...
    Logger_setLevel((LoggerLevel)settings.logLevel);
...
extern "C" void app_main(void) {
    ...
    /* Bug fix #1: NVS must be initialized before WiFi stack */
    ...
    for (;;) {
        ...
        size_t wifi_len = wifiGVRET.numAvailableBytes();
        ...
        while (uart_serial_available() > 0 && serial_cnt < 128) {
            ...
            serialGVRET.processIncomingByte(b);
        }
